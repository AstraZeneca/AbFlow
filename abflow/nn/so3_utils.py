"""
SO3 utility functions from frameflow: https://github.com/microsoft/protein-frame-flow/blob/main/data/so3_utils.py
"""
...
def geodesic_t(
    t: torch.Tensor, mat: torch.Tensor, base_mat: torch.Tensor, rot_vf=None
) -> torch.Tensor:
    """
